class ApplicationController < ActionController::Base
  before_action :authenticate_user!, except: [:new, :congratulations, :create, :provider, :seeker]
  before_action :configure_permitted_parameters, if: :devise_controller?
  include Pundit

  # Pundit: white-list approach.
  after_action :verify_authorized, except: [:index, :new, :congratulations, :create, :provider, :seeker], unless: :skip_pundit?

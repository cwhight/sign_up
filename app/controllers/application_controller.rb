class ApplicationController < ActionController::Base
  ...
  before_action :authenticate_user!, except: [:new, :congratulations, :create, :job_provider, :job_seeker]
  ...
  after_action :verify_authorized, except: [:index, :new, :congratulations, :create, :job_provider, :job_seeker], unless: :skip_pundit?
